...
import cart from "../components/cartArray";
export default {
  name: "Home",
    ...
    items: [
        {
          ...
          price: 119.9,
          description: "מכשיר זה הנו מכשיר חדש ומקורי וכולל עברית מלאה, עדכוני FOTA ו 12 חודשי אחריות."
        },
        {id: 1,
          title:
